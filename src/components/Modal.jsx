const Modal = ({ setOpenModal, delete_and_close }) => {
  ...
  return (
    <section className="fixed inset-0 grid place-items-center z-50  bg-black/30 shadow-md">
      <div className="bg-white rounded-sm w-80 px-6 h-48 pt-3 pb-3 flex flex-col gap-3.5    ">
        ...
        <div className="flex justify-between">
          <button
            className="bg-gray-400 font-black text-white px-5 rounded-sm py-1.5"
            onClick={closeModal}
          >
            No, Cancel
          </button>
          <button
            className="bg-red-500 font-black text-white px-5 rounded-sm py-1.5"
